...
## Acknowledgements
The authors gratefully acknowledge the computational resources and technical support provided by the **Red Española de Supercomputación (RES)** and **Barcelona Supercomputing Center (BSC-CNS)**. CFD simulations associated with the development and testing of this solver were performed on the **MareNostrum 5** supercomputer under allocation `IM-2025-3-0017`.
